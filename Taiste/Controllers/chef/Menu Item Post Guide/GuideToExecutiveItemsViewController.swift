//
//  GuideToExecutiveItemsViewController.swift
//  Taiste
//
//  Created by Malik Muhammad on 6/18/23.
//
...
class GuideToExecutiveItemsViewController: UIViewController {
    ...
    @IBAction func signatureDishPostPressed(_ sender: Any) {
    ...
    @IBAction func preperationContentPressed(_ sender: Any) {
        if let vc = self.storyboard?.instantiateViewController(withIdentifier: "MealKitVideo") as? YoutubeViewController  {
