//
//  GuideToCaterItemsViewController.swift
//  Taiste
//
...
class GuideToCaterItemsViewController: UIViewController {
    ...
    @IBAction func menuItemPostExample(_ sender: Any) {
    ...
    @IBAction func preperationContentButtonPressed(_ sender: Any) {
        if let vc = self.storyboard?.instantiateViewController(withIdentifier: "MealKitVideo") as? YoutubeViewController  {
